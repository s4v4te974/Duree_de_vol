...
public class Lanceur {
	...
	public static void CalculerDureeVol_v1() {
		...
		try {
			...
			int iHeure_depart_v1 = heure();
			int iMinutes_depart_v1 = minutes();
			int iHeure_arrivee_v1 = heure();
			int iMinutes_arrivee_v1 = minutes();
	...
	public static void CalculerDureeVol_v2() {		
		...
		//bloc try... catch pour gérer l'exception de chiffre non valide entrée(
		try {
			int iHeure_depart_v2 = heure();
			int iMinutes_depart_v2 = minutes();
			int iHeure_arrivee_v2 = heure();
			int iMinutes_arrivee_v2 = minutes();
	...
	public static void CalculerDureeVol_v3() {
		...
		try {
			...
			int iHeure_depart_v3 = heure();
			int iMinutes_depart_v3 = minutes();
			int iHeure_arrivee_v3 = heure();
			int iMinutes_arrivee_v3 = minutes();
	...
	public static Integer minutes() {
		...
		iMinutes = Integer.parseInt(hScanner_m_depart);
		while(!minutes_conforme(iMinutes)) {
